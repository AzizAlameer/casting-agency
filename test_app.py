...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    def test_post_actor_201(self):
        res = self.client().post(
            '/actors', json=self.actor, headers=CASTING_DIRECTOR
            )
        data = json.loads(res.data)
    ...
    def test_patch_actor_200(self):
        res = self.client().patch(
            '/actors/1', json=self.actor, headers=EXECUTIVE_PRODUCER
            )
        data = json.loads(res.data)
    ...
    def test_patch_actor_400(self):
        res = self.client().patch(
            '/actors/1', json={}, headers=EXECUTIVE_PRODUCER
            )
        data = json.loads(res.data)
    ...
    def test_post_movie(self):
        res = self.client().post(
            '/movies', json=self.movie, headers=EXECUTIVE_PRODUCER
            )
        data = json.loads(res.data)
    ...
    def test_patch_movie(self):
        res = self.client().patch(
            '/movies/1', json=self.movie, headers=EXECUTIVE_PRODUCER
            )
        data = json.loads(res.data)
